<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="角色" prop="jiaose">
          <el-select v-model="ruleForm.jiaose" placeholder="请选择角色">
            <el-option
                v-for="(item,index) in jiaoseOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="角色" prop="jiaose">
	      <el-input v-model="ruleForm.jiaose"
          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.guijitu" label="轨迹图" prop="guijitu">
          <file-upload
          tip="点击上传轨迹图"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.guijitu?ruleForm.guijitu:''"
          @change="guijituUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.guijitu" label="轨迹图" prop="guijitu">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.guijitu.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="详细路线" prop="xiangxiluxian">
          <el-input v-model="ruleForm.xiangxiluxian" 
              placeholder="详细路线" clearable  :readonly="ro.xiangxiluxian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="详细路线" prop="xiangxiluxian">
              <el-input v-model="ruleForm.xiangxiluxian" 
                placeholder="详细路线" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
            continue;
	            	            ...
	            	            if(o=='guijitu'){
            this.ruleForm.guijitu = obj[o];
	    this.ro.guijitu = true;
            continue;
          }
	            	            if(o=='xiangxiluxian'){
            this.ruleForm.xiangxiluxian = obj[o];
	    this.ro.xiangxiluxian = true;
            continue;
          }
	            	            if(o=='shijianduan'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                          ...
                                          this.jiaoseOptions = "学生,教师".split(',')
                                                                                                                      },
                                                        // 多级联动参数
                                                                        info(id) {
      this.$http({
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                ...
                                                guijituUploadChange(fileUrls) {
                this.ruleForm.guijitu = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                	addEditStyleChange() {
	  this.$nextTick(()=>{
