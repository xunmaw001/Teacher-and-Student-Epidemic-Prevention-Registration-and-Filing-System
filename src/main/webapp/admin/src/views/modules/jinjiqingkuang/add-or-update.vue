        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.jiaose"
                placeholder="角色" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="上报人" prop="shangbaoren">
          <el-input v-model="ruleForm.shangbaoren" 
              placeholder="上报人" clearable  :readonly="ro.shangbaoren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="上报人" prop="shangbaoren">
              <el-input v-model="ruleForm.shangbaoren" 
                placeholder="上报人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zhaopian" label="照片" prop="zhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zhaopian.split(',')" :src="item" width="100" height="100">
                                                                                                                                                                          ...
                                                                                                                                                                          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="详细" prop="xiangxi">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.xiangxi" label="详细" prop="xiangxi">
                    <span v-html="ruleForm.xiangxi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaose = true;
            continue;
	            	            ...
	            	            if(o=='shangbaoren'){
            this.ruleForm.shangbaoren = obj[o];
	    this.ro.shangbaoren = true;
            continue;
          }
	            	            if(o=='biaoti'){
	    ...
	    this.ro.zhaopian = true;
            continue;
	            	            ...
	            	            if(o=='xiangxi'){
            this.ruleForm.xiangxi = obj[o];
	    this.ro.xiangxi = true;
            continue;
          }
	            	            if(o=='userid'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jinjiqingkuang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jinjiqingkuangCrossAddOrUpdateFlag = false;
                  this.parent.search();
