          ...
          <el-form-item class="input" label="发布人" prop="faburen">
              <el-input v-model="ruleForm.faburen" 
                placeholder="发布人" readonly></el-input>
                                                                                                                                ...
                                                                                                                                <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="详细内容" prop="xiangxineirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.xiangxineirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiangxineirong" label="详细内容" prop="xiangxineirong">
                    <span v-html="ruleForm.xiangxineirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
            continue;
	            	            ...
	            	            if(o=='xiangxineirong'){
            this.ruleForm.xiangxineirong = obj[o];
	    this.ro.xiangxineirong = true;
            continue;
          }
	            	            if(o=='fabushijian'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `fangyicuoshi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fangyicuoshiCrossAddOrUpdateFlag = false;
                  this.parent.search();
