  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.celiangtupian" label="测量图片" prop="celiangtupian">
          <file-upload
          tip="点击上传测量图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.celiangtupian?ruleForm.celiangtupian:''"
          @change="celiangtupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.celiangtupian" label="测量图片" prop="celiangtupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.celiangtupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="体温" prop="tiwen">
              <el-input v-model="ruleForm.tiwen" 
                placeholder="体温" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="上报时间" prop="shangbaoshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shangbaoshijian" label="上报时间" prop="shangbaoshijian">
              <el-input v-model="ruleForm.shangbaoshijian" 
                placeholder="上报时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                            </el-row>
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
            continue;
	            	            ...
	            	            if(o=='celiangtupian'){
            this.ruleForm.celiangtupian = obj[o];
	    this.ro.celiangtupian = true;
            continue;
          }
	            	            if(o=='tiwen'){
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                ...
                                                celiangtupianUploadChange(fileUrls) {
                this.ruleForm.celiangtupian = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                	addEditStyleChange() {
	  this.$nextTick(()=>{
